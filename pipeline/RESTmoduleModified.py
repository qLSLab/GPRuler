...
def kegg_conv(target_db, source_db, option=None):
    ...
    if target_db in ["ncbi-gi", "ncbi-geneid", "ncbi-proteinid", "uniprot", "genes", "ensembl", "hgnc"] or \
       source_db in ["ncbi-gi", "ncbi-geneid", "ncbi-proteinid", "uniprot", "genes", "ensembl", "hgnc"] or \
