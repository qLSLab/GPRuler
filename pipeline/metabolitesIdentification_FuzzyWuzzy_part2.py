...
dfMatches91_99 = pd.read_csv(os.path.join(OUTDIR, outputFileName + '_mappingMetaCyc_91_99.tsv'), sep="\t", index_col = 0)
...
## Automatic interaction with the user to curate the list of putative matches with score between 91 and 99
dfMatches91_99 = pd.read_csv(os.path.join(OUTDIR, outputFileName + '_mappingKeggC_91_99.tsv'), sep="\t", index_col = 0)
dfMatches91_99['Matches'] = dfMatches91_99['Matches'].apply(ast.literal_eval)
...
## Automatic interaction with the user to curate the list of putative matches with score between 91 and 99
dfMatches91_99 = pd.read_csv(os.path.join(OUTDIR, outputFileName + '_mappingKeggG_91_99.tsv'), sep="\t", index_col = 0)
dfMatches91_99['Matches'] = dfMatches91_99['Matches'].apply(ast.literal_eval)
...
## Automatic interaction with the user to curate the list of putative matches with score between 91 and 99
dfMatches91_99 = pd.read_csv(os.path.join(OUTDIR, outputFileName + '_mappingChebi_91_99.tsv'), sep="\t", index_col = 0)
dfMatches91_99['Matches'] = dfMatches91_99['Matches'].apply(ast.literal_eval)
